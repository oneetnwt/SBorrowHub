...
const ChartsSkeleton = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
    {[1, 2].map((i) => (
      <div
        key={i}
        className="bg-white rounded-lg shadow-sm border border-black/10 p-5 animate-pulse"
      >
...
const SystemInfoSkeleton = () => (
  <div className="bg-white rounded-lg shadow-sm border border-black/10 p-5 mb-5 animate-pulse">
...
const QuickActionsSkeleton = () => (
  <div className="bg-white rounded-lg shadow-sm border border-black/10 p-5 animate-pulse">
    <div className="h-6 bg-gray-200 rounded w-32 mb-4"></div>
...
function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchAllDashboardData = async () => {
      try {
        const [officerRes, userRes, statsRes, systemInfoRes] =
          await Promise.all([
        ...
        // Set initial uptime for counter
