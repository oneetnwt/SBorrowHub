                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        <img
                          src={
                            txn.borrowerId?.profilePicture ||
                            `https://ui-avatars.com/api/?name=${txn.borrowerId?.firstname}+${txn.borrowerId?.lastname}&background=be8443&color=fff`
                          }
                        ...
                        <div>
                          <p className="font-medium text-gray-900">
                            {txn.borrowerId?.firstname}{" "}
                            {txn.borrowerId?.lastname}
                          </p>
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                  <img
                    src={
                      ...
                      `https://ui-avatars.com/api/?name=${selectedTransaction.borrowerId?.firstname}+${selectedTransaction.borrowerId?.lastname}&background=be8443&color=fff`
                    }
                    alt={selectedTransaction.borrowerId?.fullname}
                    className="w-16 h-16 rounded-full object-cover"
                  />
                  <div>
                    <p className="font-semibold text-lg text-gray-900">
                      {selectedTransaction.borrowerId?.firstname}{" "}
                      {selectedTransaction.borrowerId?.lastname}
                    </p>
                    <p className="text-gray-600">
                      {selectedTransaction.borrowerId?.email}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="font-semibold text-gray-900">
                      {selectedTransaction.condition || "Good"}
                    </p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
